...
uint16_t posencoder1=0;
uint16_t posencoder2=0;
/**
  * 函    数：编码器初始化
  * 参    数：无
  * 返 回 值：无
...
{
	/*开启时钟*/
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM3|RCC_APB1Periph_TIM4, ENABLE);			//开启TIM3的时钟
	...
	/*TIM使能*/
	TIM_Cmd(TIM3, ENABLE);	
	TIM_Cmd(TIM4, ENABLE);		//使能TIM3，定时器开始运
}
